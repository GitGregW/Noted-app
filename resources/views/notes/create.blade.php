    ...
    <div style="padding:1em 3em;min-height: 100vh;background: linear-gradient(90deg, #FFFFFF -53.09%, #969798 9.67%, #969798 89.45%, #FFFFFF 157.64%);">
        <form action="/notes/create" method="post">
            ...
            <div style="margin-bottom: 1rem;display:flex;justify-content: space-between;">
                <a href="{{ route('notes') }}" style="margin:auto 0;">
                ...
                <div style="position: relative;margin: 0 1em;">
                    <input type="text" name="folder" id="folder" style="width: 100%;color: white;font-size: 1.2rem;background: none;border: none;border-bottom: 1px #D1D1D1 solid;padding-left: 3em;">
            ...
            <div style="width:100%;min-height:18em;margin:1em 0;padding:1em 1.5em;background: #494949;border: 1px solid #889CAE;border-radius: 5px;">
                <div style="position: relative;margin: 0 1em;">
                    <input type="text" name="header" id="header" style="color: white;font-size: 1.4rem;background: none;border: none;border-bottom: 1px #D1D1D1 solid;padding-left: 3em;">
                    <label for="header" style="color: #D1D1D1;font-size: 0.8rem;position: absolute;left: 0.5em;bottom:0.5em;">Header</label>
                </div>
                <div style="position: relative;margin: 1.5em 0;">
                    <textarea name="description" id="description" rows="5" style="width:100%;color: white;font-size: 1.2rem;background: none;border: 1px #D1D1D1 solid;padding: 0.8em;padding-left: 0.25em;"></textarea>
            ...
            <div style="display: flex;justify-content: space-evenly;">
                ...
                border-radius: 0.5em;padding: 0.75em;">Add Note</button>

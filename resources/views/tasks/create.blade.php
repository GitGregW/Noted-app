<x-app-layout>
    ...
    <div style="padding:1em 3em;min-height: 100vh;background: linear-gradient(90deg, #FFFFFF -53.09%, #969798 9.67%, #969798 89.45%, #FFFFFF 157.64%);">
        <form action="{{ $folder->path() . '/tasks' }}" method="post">
            @csrf
            ...
            <div style="width:100%;min-height:18em;margin:1em 0;padding:1em 1.5em;background: #494949;border: 1px solid #889CAE;border-radius: 5px;">
                <div style="position: relative;margin: 1.5em 0;">
                    <input type="text" name="body" id="body" style="width:100%;color: white;font-size: 1.2rem;background: none;border: 1px #D1D1D1 solid;padding: 0.8em;padding-left: 0.25em;">
                    <label for="body" style="color: #D1D1D1;font-size: 0.8rem;position: absolute;right: 0.5em;top:0;">Task</label>
                </div>
            ...
            <div style="display: flex;justify-content: space-evenly;">
                ...
                border-radius: 0.5em;padding: 0.75em;">Add Task</button>
